...
export default function Navbar() {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-30 mx-auto mb-4 flex origin-bottom h-full max-h-14">
      ...
      <Dock className="z-50 pointer-events-auto relative mx-auto flex min-h-full h-full items-center px-1.5 bg-background/80 backdrop-blur-xl rounded-2xl border border-border/40 shadow-[var(--shadow-lg)] transform-gpu dark:bg-background/70 dark:border-border/30">
